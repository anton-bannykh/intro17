...
2. Первые шаги: простой метод и тесты к нему
  ...
  * Создайте pull-request, в нем не должен вновь быть помеченным как измененный файл `.gitignore`. Если это так идти [сюда](https://robots.thoughtbot.com/keeping-a-github-fork-updated/)
